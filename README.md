...
- the default colors that enabled in the script are Blue lines with Brown content
...
**INFO:** I didn't added more colors code to the table content, because i find out that Brown color has a good contrast
